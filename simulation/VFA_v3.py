...
list_node=[]
while i<nb_node:
    temp=Node(np.random(), np.random(),i)
    print(temp.display())
...
if test==index+1:
    print("Opimized after {} iterations".format(iteration))
else:
    print("Non optimized after {} iterations".format(Max_iteration))
print("Area covered at {} %".format(Estimate_coverage(list_node)))
